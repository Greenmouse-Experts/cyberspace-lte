...
function PersonalPlanItem({
  ...
  return (
    <>
      <div className="border flex  flex-col justify-between  border-bluePrimary py-8 px-4 rounded-2xl font-inter shadow-sm hover:-translate-y-1 transition-all hover:shadow-xl">
