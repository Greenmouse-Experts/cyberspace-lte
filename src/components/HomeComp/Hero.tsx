...
function Hero() {
  return (
    <>
      ...
      <section className="font-grotesk border grid md:grid-cols-6 grid-cols-2 justify-start items-center  sm:gap-0 gap-5  border-[#E4E7E9] dark:bg-gray-200 transition-colors  rounded-[10px] px-10 py-5 mt-10 md:divide-x divide-grey-400 dark:divide-gray-900 ">
