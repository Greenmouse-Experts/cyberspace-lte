   ...
   <div className=" mt-5">
        ...
        <div className="mb-12">
          ...
          <p className=" ">
            ...
            time. We do not guarantee, represent and or warrant that our site,
            or any content, will always be available or uninterrupted. We may
            suspend, withdraw, or restrict the availability of all or any part
            of our site for business and operational reasons. We will try to
            give you reasonable notice of any suspension or withdrawal. You are
            also responsible for ensuring that all persons who access our site
            through you are aware of these terms of use and other applicable
        ...
        <div className="mb-12">
          ...
          <p className=" ">
            ...
            by intellectual property rights laws and treaties around the world.
            All such rights are reserved. You may print off one copy and may
            download extracts, of any page(s) from our site for your personal
            use and you may draw the attention of others within your
            organization to content posted on our site. You must not modify the
            ...
            photographs, video or audio sequences, or any graphics setely
            from any accompanying text. Our status (and that of any identified
            contributors) as the authors of content on our site must always be
            acknowledged. You must not use any part of the content on our site
            for commercial purposes without obtaining a license to do so from
            us. If you print off, copy, download, share or repost any part of
            ...
            destroy any copies of the materials you have made. This is without
            prejudice to any other rights or remedies available in law,
            contractually, or in equity.
          </p>
        ...
        <div className="mb-12">
          ...
          <p className=" ">
            ...
            Nigeria, with RC No. 1525168, duly licensed by the Central Bank of
            Nigeria, and have our principal office at No 33, Saka Tinubu Street,
            Victoria Island, Lagos State, Nigeria. To contact us, please email
            customersupport@cyberpay,net.ng or telephone our customer service
            line on +234
          </p>
        </div>
        ...
        <div className="mb-12">
          ...
          <p className=" ">
            ...
            with this Acceptable Use Policy. Our Cookie Policy and as contained
            in the Privacy Policy, which sets out information about the cookies
            on our site. If you purchase or subscribe to products or services or
            perform transactions or payments from/through our site, our terms
            and conditions of service delivery/provision will apply.
          </p>
        </div>
        ...
        <div className="mb-12">
          ...
          <p className=" ">
            ...
            via, or about, our site. This includes using (or permitting,
            authorizing, or attempting the use of): Any “robot”, “bot”,
            “spider”, “scraper” or other automated devices, program, tool,
            algorithm, code, process, or methodology to access, obtain, copy,
            monitor, or republish any portion of the site or any data, content,
            information or services accessed via the same. &bull; Any automated
            analytical technique aimed at analyzing text and data in digital
            form to generate information that includes but is not limited to
            patterns, trends, and correlations. The provisions in this clause
            should be treated as an express reservation of our rights in this
            regard. This site its content and any services provided about the
            same are only targeted to and intended for use by, persons located
            in the Federal Republic of Nigeria and such other jurisdiction in
            which we operate (each, a Permitted Territory). By continuing to
            access, view, or make use of this site and any related content and
            services, you hereby warrant and represent to us that you are
            located in a Permitted Territory. If you are not located in a
            Permitted Territory, you must immediately discontinue the use of
            this site and any related content and services.
          </p>
        </div>
        ...
        <div className="mb-12">
          ...
          <p className=" ">
            ...
            commercial purposes (as duly agreed with you in writing). It is not
        ...
        <div className="mb-12">
          ...
          <p className=" ">
            ...
            users of the site, including bulletin boards and or chat rooms. This
        ...
        <div className="mb-12">
          ...
          <p className=" ">
            ...
            of our site and or the Services or the provision of content to us by
            you and in respect of all costs, actions, losses, claims,
            proceedings, damages, expenses (including reasonable legal costs and
            expenses), or liabilities whatsoever suffered or incurred directly
            or indirectly by us in consequence of such use of this site and the
            services or provision of content or your breach or nonobservance of
        ...
        <div className="mb-12">
          ...
          <p className=" ">
            When you upload, insert or post content to our site, you grant us
            the following rights to use that content
          </p>
          <p className="  mt-12">
            ...
            user-generated content in connection with the service provided by
            the site and across different media including promoting the site or
            the service for other users, partners or advertisers.{" "}
          </p>

          <p className="  mt-12">
            &bull; A worldwide, non-exclusive, non-revocable, unlimited,
            royalty-free, transferable license for other users, partners, or
            advertisers to use the content for their purposes or in accordance
            with the functionality of the site. We are not responsible for
            viruses and you must not introduce them We do not guarantee that our
            site will be secure or free from bugs or viruses. You are
            responsible for configuring your information technology, computer
            programs, and platform to access our site. You should use your virus
            protection software. You must not misuse our site by introducing
            ...
            you would commit a criminal offense under the applicable laws. We
        ...
        <div className="mb-12">
          ...
          <p className=" ">
            ...
            policy constitutes a material breach, upon which you are permitted
            to use, navigate, access, or visit our site, and may result in our
        ...
        <div className="mb-12">
          ...
          <p className=" ">
            ...
            You must not establish a link to our site on any site that is not
            ...
            The site/platform to which you are linking must comply in all
            respects with the content standards set out in our Acceptable Use
            Policy. If you wish to link to or make any use of the content on our
            site other than that set out above, please contact
            info@cyberpay.net.ng
          </p>
        </div>
        ...
        <div className="mb-12">
          ...
          <p className=" ">
            ...
            Policy You warrant and represent that any such contribution which
            does comply with those standards, you will be liable to us and fully
            indemnify us for any breach of that warranty or representation. This
            means you will be responsible for any liability, claims, cost, loss,
            and or damage we suffer or are likely to suffer as a result of your
            breach of warranty, representation, or breach of this policy. Any
            content you upload to our site will be considered non-confidential
            ...
            store and copy that content and to distribute and make it available
            to third parties. We also have the right to disclose your identity
            ...
            intellectual property rights or their right to privacy and or
            regulators. We have the right to remove any posting you make on our
            site if, in our opinion, your post does not comply with the content
            standards set out in our Acceptable Use Policy. You are solely
        ...
        <div className="mb-12">
          ...
          <p className=" ">
            ...
            formation (and any non-contractual disputes or claims), are governed
            by the laws of the Federal Republic of Nigeria. You and we both
            agree to use all reasonable endeavors to settle any dispute or
            difference of opinion between them, arising from or in connection
            with this policy amicably through mutual discussion. However, if
            such cannot be amicably resolved between the Parties within ninety
            (90) business days after the occurrence of such dispute, we and or
            you may refer such dispute to mediation upon giving the other party
